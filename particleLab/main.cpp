...
//    g_pParticleSystems[1]->SetTexture( "..\\particle.bmp" );
    ...
    g_pParticleSystems[6]->SetMaxParticles( 5000 );
    g_pParticleSystems[6]->SetNumToRelease( 70 );
    g_pParticleSystems[6]->SetReleaseInterval( 0.1f );
    g_pParticleSystems[6]->SetLifeCycle( 4.0f );
    g_pParticleSystems[6]->SetSize( 13.0f );
    g_pParticleSystems[6]->SetColor( MyVector( 0.0f, 0.0f, 1.0f ));
    g_pParticleSystems[6]->SetPosition( MyVector( 0.0f, 8.0f, 0.0f) );
    g_pParticleSystems[6]->SetVelocity( MyVector( 0.0f, 5.0f, 0.0f) );
    g_pParticleSystems[6]->SetGravity( MyVector( 0.0f, -10.8f, 0.0f) );
    g_pParticleSystems[6]->SetWind( MyVector( 0.0f, 0.0f, 0.0f) );
    g_pParticleSystems[6]->SetVelocityVar( 5.0f );

	g_pParticleSystems[6]->SetCollisionPlane( MyVector( 0.0f, 1.0f, 0.0f ), 
                                          MyVector( 0.0f, -6.0f, 0.0f ) ); // Floor
